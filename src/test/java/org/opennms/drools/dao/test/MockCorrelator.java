...
public class MockCorrelator implements CorrelationEngineRegistrar {
    ...
    /* This method isn't defined in the 19.1.0-1 version of the CorrelationEngineRegistrar interface.
     * But it is in the Meridian 2017 series, and Horizon 20.1.0-1 onward.
      @Override
     */
